# Nexlayer — wild-peak-memos

**Live:** [https://kitbear-studio-wild-peak-memos.cloud.nexlayer.ai](https://kitbear-studio-wild-peak-memos.cloud.nexlayer.ai)  

**Runtime:** go · **Port:** 5230 · **Deploy branch:** main

---

## How this deployment works

**wild-peak-memos** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
> The container exposes port 5230. When adding a new service (database, cache,
